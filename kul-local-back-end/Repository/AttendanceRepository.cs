...
namespace kul_local_back_end.Repositories
{
    public class AttendanceRepository : BaseRepository<Attendance>, IAttendance
    {
        ...
        public AttendanceRepository(IMongoDatabase db, string collectionName) : base(db, collectionName)
        {
    ...
    .ToList();
            return Results.Ok(new { data = attendances });
        }
        ...
        private async Task<List<AttendanceResponse>> GetPopulatedAttendancesAsync(FilterDefinition<Attendance> filter)
        {
