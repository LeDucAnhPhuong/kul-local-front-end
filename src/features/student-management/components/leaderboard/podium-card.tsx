  ...
  switch (rank) {
    ...
    case 2:
      return {
        ...
        icon: <Medal className="text-gray-100 h-7 w-7" />,
        title: '🥈 Á QUÂN',
        height: 'h-72',
    ...
    case 3:
      return {
        ...
        icon: <Award className="w-6 h-6 text-amber-100" />,
        title: '🥉 HẠN BA',
        height: 'h-64',
    ...
    default:
      return {
        ...
        icon: <Star className="w-5 h-5 text-blue-100" />,
        title: `#${rank}`,
        height: 'h-56',
...
return (
  ...
  >
    ...
    {rank === 1 && (
      <>
        <Sparkles className="absolute w-6 h-6 text-yellow-200 top-2 right-2 animate-pulse" />
        <Sparkles className="absolute w-4 h-4 text-yellow-300 delay-300 top-4 left-4 animate-pulse" />
        <Sparkles className="absolute w-5 h-5 text-yellow-200 delay-700 bottom-4 right-4 animate-pulse" />
      </>
    )}
    ...
    >
      ...
      <div className="mb-2 text-3xl font-bold text-gray-200">{entry.averageScore.toFixed(1)}</div>
